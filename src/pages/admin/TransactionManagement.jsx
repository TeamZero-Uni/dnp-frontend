...
import DeleteTransaction from "../../components/view/DeleteTransaction";
...
const METHOD_ICONS = {
  card: <FiCreditCard size={12} />,
  cash: <FiDollarSign size={12} />,
};
      ...
      <header className="bg-white border-b border-violet-100 sticky top-0 z-30">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-base font-bold leading-none text-[#1e1b4b]">
                Transaction Hub
              </h1>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-6 space-y-6">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            {
              label: "Total Revenue",
              value: `Rs ${total.toLocaleString("en", { minimumFractionDigits: 2 })}`,
            ...
            <div
              key={s.label}
              className={`bg-white rounded-2xl border ${s.border} p-4 flex items-center gap-3`}
            >
              <div
              ...
              <div>
                <p className="text-xs text-slate-400 font-semibold uppercase tracking-wider leading-none mb-1">
                  {s.label}
                </p>
        ...
        <div className="bg-white rounded-2xl border border-violet-100 overflow-hidden hidden md:block">
          <div className="grid grid-cols-10 px-6 py-3 bg-slate-50 border-b border-slate-100 text-xs font-bold text-slate-400 uppercase tracking-widest">
              ...
              filtered.map((t) => {
                ...
                return (
                  <div
                    ...
                    className="grid grid-cols-10 items-center px-6 py-4 hover:bg-violet-50/40 transition-colors group"
                  >
                    <div className="col-span-2">
                      <span className="text-sm font-black text-slate-800">
                        Rs{" "}
                        {parseFloat(t.amount).toLocaleString("en", {
                    ...
                    <div className="col-span-2">
                      <span
                        className={`inline-flex items-center gap-1.5 text-xs font-bold px-2.5 py-1 rounded-full border ${st.bg} ${st.text} ${st.border}`}
                      >
                        <span

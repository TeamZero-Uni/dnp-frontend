    ...
    <div className="min-h-screen bg-slate-50 font-sans">
      <Banner
        ...
        title={
          <>
            Get In Touch With
            <br />
            <span className="text-[#5a46c2]">Our Studio</span>
          </>
        }
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 grid grid-cols-1 lg:grid-cols-5 gap-8">
        <div className="lg:col-span-2 flex flex-col gap-5">
          <div className="bg-white rounded-2xl border border-violet-100 overflow-hidden">
            ...
            <div className="divide-y divide-slate-50">
              {[
                ...
                >
                  <div
                    className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 ${bg} ${color} border ${border}`}
                  >
                    {icon}
                  </div>
                  <div className="flex-1 min-w-0">
                    <p className="text-xs text-slate-400 font-semibold uppercase tracking-widest leading-none mb-0.5">
                      {label}
                    </p>
          ...
          <div className="bg-white rounded-2xl border border-violet-100 px-5 py-7 flex items-start gap-4">
            ...
            {sent ? (
              <div className="flex flex-col items-center justify-center py-20 px-6 text-center">
                ...
                <p className="text-sm text-slate-400 max-w-xs leading-relaxed mb-6">
                  ...
                  <span className="font-bold text-slate-600">{form.email}</span>{" "}
                  shortly.
                </p>
                <button
              ...
              >
                <div className="sm:col-span-1">
                  <label className="flex items-center gap-1.5 text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">
                    <FaUser size={9} className="text-violet-500" /> Full Name{" "}
                ...
                <div className="sm:col-span-1">
                  <label className="flex items-center gap-1.5 text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">
                    <FaEnvelope size={9} className="text-violet-500" /> Email{" "}
                    <span className="text-red-400">*</span>
                  </label>
                  <input
                    name="email"
                ...
                <div className="sm:col-span-1">
                  <label className="flex items-center gap-1.5 text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">
                    <FaCommentDots size={9} className="text-violet-500" />{" "}
                ...
                <div className="sm:col-span-2 flex items-center justify-between gap-4">
                  ...
                  <button
                    ...
                    style={{
                      background: "linear-gradient(135deg,#5a46c2,#4838a3)",
                      boxShadow: "0 6px 20px rgba(90,70,194,.35)",
                    }}
                  >
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 pb-16">
        <div className="bg-white rounded-2xl border border-violet-100 overflow-hidden shadow-sm">
          <div className="w-full h-96 relative bg-slate-100">
            <iframe
              title="Studio3D Location"
              className="w-full h-full grayscale-[0.2] contrast-[1.1]"
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d63371.815297071!2d79.8211858716353!3d6.921833528153403!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae253d10f7a7003%3A0x320b2e4d32d3838d!2sColombo!5e0!3m2!1sen!2slk!4v1710000000000!5m2!1sen!2slk"
              style={{ border: 0 }}
              allowFullScreen=""
              loading="lazy"
